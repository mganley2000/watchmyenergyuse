...
namespace Energy.Library
{
    ...
    /// sqlite EW.s3db .dump > output.sql
    /// </summary>
    public class DatabaseController
    {
        ...
        public static int UpdateMeter(Meter meter)
        {
            ...
            sb.Append("MeCalibratedVREF = @vref,");
            sb.Append("MeCalibratedInd = @calibrated ");
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@vref", meter.CalibratedVREF);
                cmd.Parameters.AddWithValue("@calibrated", meter.IsCalibratedVREF);
        ...
        public static int UpdateMeterCalibration(int meterid, int vref)
        {
            SQLiteConnection conn;
            SQLiteCommand cmd;
            int rowCount;
            ...
            sb.Append("UPDATE Meter SET ");
            sb.AppendFormat("MeCalibratedVREF = {0},", vref);
            sb.Append("MeCalibratedInd = 1 ");
            sb.AppendFormat("WHERE MeID = {0} ", meterid);
        ...
        public static MeterCollection GetMeters()
        {
            ...
            sb.Append("SELECT MeID, MeMtID, MeName, MeDescription, MeCalibratedVREF, MeCalibratedInd FROM Meter ");
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (reader["MeCalibratedVREF"] != DBNull.Value) { meter.CalibratedVREF = (int)((long)reader["MeCalibratedVREF"]); }
                    if (reader["MeCalibratedInd"] != DBNull.Value) { meter.IsCalibratedVREF = (bool)reader["MeCalibratedInd"]; }
                    meters.Add(meter);
                }
        ...
        public static Meter GetMeter(int meterid)
        {
            ...
            sb.Append("SELECT MeID, MeMtID, MeName, MeDescription, MeCalibratedVREF, MeCalibratedInd FROM Meter WHERE MeID = @meterid ");
        ...
        public static Configuration GetConfiguration()
        {
            ...
            sb.Append("SELECT CnName, CnDescription, CnCOMPort, CnBaud, CnParity, CnDataBits, CnStopBits, CnSelectedRate ");
        ...
        public static int InsertReading(int meterid, Enums.Interval interval, Enums.UnitOfMeasure uom, DateTime intervalEnd, double energyConsumption)
        {
            SQLiteConnection conn;
            SQLiteCommand cmd;
            int rowCount;
            ...
            formatDate = intervalEnd.ToString("yyyy/MM/dd HH:mm:ss");

            sb.Append("INSERT INTO Reading (JaMeID, JaInID, JaUnID, JaDatestamp, JaRead) ");
            sb.Append("VALUES ");
            sb.AppendFormat("( @meterID, @interval, @uom, @intervalEnd, @energyConsumption )");
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@intervalEnd", formatDate);
